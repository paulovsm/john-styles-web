...
export default function Button({
    ...
    const baseStyles = "inline-flex items-center justify-center min-h-[44px] px-5 py-2 border text-sm font-semibold rounded-full transition-transform transition-colors active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed";
