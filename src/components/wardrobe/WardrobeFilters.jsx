            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                    <select
                        ...
                        onChange={handleChange}
                        className="wardrobe-filter-select block w-full pl-3 pr-10 py-2 text-base border-grey-light focus:outline-none focus:ring-brand-navy focus:border-brand-navy sm:text-sm rounded-md"
                    >
