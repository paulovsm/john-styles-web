        ...
        <div className="py-12 bg-white-off">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="lg:text-center">
                    <h2 className="text-base text-brand-gold-dark font-semibold tracking-wide uppercase">{t('landing.features.eyebrow', 'Recursos')}</h2>
                    <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-brand-navy sm:text-4xl font-serif">
                    ...
                    <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
                        {features.map((feature) => (
                            <div key={feature.name} className="relative">
                                <dt>
                                    <div className="absolute flex items-center justify-center h-12 w-12 rounded-md bg-brand-navy text-white-pure">
                                        <feature.icon className="h-6 w-6" aria-hidden="true" />
                                    </div>
                                    <p className="ml-16 text-lg leading-6 font-medium text-brand-navy">{feature.name}</p>
                                </dt>
